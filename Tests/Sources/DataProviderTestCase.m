...
- (void)testPrepareToPlayMediaComposition
{
    ...
    [[dataProvider mediaCompositionForURN:@"urn:swi:video:42297626" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        ...
        [self.mediaPlayerController prepareToPlayMediaComposition:mediaComposition atTime:kCMTimeZero withToleranceBefore:kCMTimeZero toleranceAfter:kCMTimeZero preferredStreamingMethod:SRGStreamingMethodNone streamType:SRGStreamTypeDVR quality:SRGQualityHD DRM:NO startBitRate:0 userInfo:nil completionHandler:^{
...
- (void)testPrepareToPlay360Video
{
    ...
    [[dataProvider mediaCompositionForURN:@"urn:rts:video:8414077" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        ...
        [self.mediaPlayerController prepareToPlayMediaComposition:mediaComposition atTime:kCMTimeZero withToleranceBefore:kCMTimeZero toleranceAfter:kCMTimeZero preferredStreamingMethod:SRGStreamingMethodNone streamType:SRGStreamTypeNone quality:SRGQualityNone DRM:NO startBitRate:0 userInfo:nil completionHandler:^{
...
- (void)testPlayMediaComposition
{
    ...
    [[dataProvider mediaCompositionForURN:@"urn:swi:video:42297626" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        ...
        [self.mediaPlayerController playMediaComposition:mediaComposition atTime:kCMTimeZero withToleranceBefore:kCMTimeZero toleranceAfter:kCMTimeZero preferredStreamingMethod:SRGStreamingMethodNone streamType:SRGStreamTypeNone quality:SRGQualityHD DRM:NO startBitRate:0 userInfo:nil];
    }] resume];
...
- (void)testMetadata
{
    ...
    [[dataProvider mediaCompositionForURN:@"urn:srf:video:c4927fcf-e1a0-0001-7edd-1ef01d441651" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        ...
        [self.mediaPlayerController prepareToPlayMediaComposition:mediaComposition atTime:kCMTimeZero withToleranceBefore:kCMTimeZero toleranceAfter:kCMTimeZero preferredStreamingMethod:SRGStreamingMethodNone streamType:SRGStreamTypeNone quality:SRGQualityHD DRM:NO startBitRate:0 userInfo:userInfo completionHandler:^{
