 ...
 *  @param preferredStreamingMethod The streaming method to use. If `SRGStreamingMethodNone` or if the method is not
 ...
 *                                  is used.
 *  @param preferredStartBitRate    The bit rate the media should start playing with, in kbps. This parameter is a 
